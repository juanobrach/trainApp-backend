...
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
		    ...
		    <div id="jsstadmin-wrapper-top-left">
		        <div id="jsstadmin-breadcrunbs">
		            <ul>
		                ...
		                <li><?php echo __('User Detail Report','js-support-ticket'); ?></li>
		            </ul>
		        </div>
		    </div>
    	...
    	<div id="jsstadmin-head">
            <h1 class="jsstadmin-head-text"><?php echo __("User Detail Report", 'js-support-ticket') ?></h1>
        ...
        <div id="jsstadmin-data-wrp" class="p0 bg-n bs-n">
			...
			<div class="js-admin-report">
				<div class="js-admin-subtitle"><?php echo __('User Statistics','js-support-ticket'); ?></div>
					...
					<div class="js-admin-staff-wrapper">
						<div class="js-admin-staff-cnt">
							<div class="js-report-staff-image">
								...
								?>
								<img class="js-report-staff-pic" src="<?php echo esc_url($imageurl); ?>" alt="<?php echo __('staff image','js-support-ticket'); ?>"/>
							</div>
			...
			<?php
				if(!empty(jssupportticket::$_data['user_tickets'])){ ?>
					...
					foreach(jssupportticket::$_data['user_tickets'] AS $ticket){
						...
						<tr>
							<td class="left">
								<a target="_blank" href="<?php echo admin_url('admin.php?page=ticket&jstlay=ticketdetail&jssupportticketid='.$ticket->id); ?>" title="<?php echo __('Ticket','js-support-ticket'); ?>">
