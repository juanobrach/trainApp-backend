...
$jssupportticket_css .= '
	...
	div.js-ticket-fields-wrp div.js-ticket-form-field select.js-ticket-field-input{float: left;width: 100%;border-radius: 0px; padding: 10px;background: url('.jssupportticket::$_pluginpath.'includes/images/selecticon.png) 96% / 4% no-repeat ;line-height: initial;height: 50px;}
