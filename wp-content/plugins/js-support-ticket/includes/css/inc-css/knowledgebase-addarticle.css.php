...
span.tk_attachment_value_text span.tk_attachment_remove{background: url('.jssupportticket::$_pluginpath.'includes/images/close.png) no-repeat;background-size: 100% 100%;position: absolute;width: 30px;height: 30px;top: 10px;right:6px;}
