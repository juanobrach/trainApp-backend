<tr id="<?php echo esc_attr( sanitize_title( $addon_slug . '_transaction_key_row' ) ); ?>" class="active plugin-update-tr jsst-updater-licence-key-tr">
	<td class="plugin-update" colspan="3">
		<div class="jsst-updater-licence-key">
			...
			<div>
				<span class="description"><?php _e( 'Please select )'.strtoupper( substr( $updateaddon_slug, 0, 2 ) ).substr(  ucwords($updateaddon_slug), 2 ).'</b> and Enter your license key and hit to authenticate. A valid key is required for updates.' ); ?> <?php printf( 'Lost your key? <a href="%s">Retrieve it here</a>.', esc_url( 'https://jshelpdesk.com/' ) ); ?></span>
			</div>
		</div>
	</td>
</tr>
